...
def task_pull_RCON_RCOA():
    ...
    return {
        "actions": [
            ...
            "ipython src/pull_WRDS_call_reports.py",
        ],
        "targets": targets,
        "file_dep": file_dep,
        "clean": True,
...
def task_compile_latex_docs():
    ...
    return {
        "actions": [
            ...
            "latexmk -xelatex -halt-on-error -c -cd ./reports/replication_report.tex",  # Clean
        ],
        "targets": targets,
        "file_dep": file_dep,
        "clean": True,
